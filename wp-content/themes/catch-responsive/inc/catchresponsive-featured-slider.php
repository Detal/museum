 ...
 *
 */
/*============================изменил src для изображений по умолчанию====================================*/
...
//*========================все что ниже заменить содеожимым файла с пометкой MY файл в этой же папке=============*/
				$catchresponsive_page_slider .= '
				</figure>
			</article><!-- .slides -->';
		endwhile;
