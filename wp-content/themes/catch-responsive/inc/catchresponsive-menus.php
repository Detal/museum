...
function catchresponsive_primary_menu() {
    ...
    <!--кнопка скрытого меню-->
     <div class="holder_img_menu_show">
        <i id="img_menu_show" class="fa fa-bars" aira-hidden="true"></i> <!--<img src="/wp-content/themes/catch-responsive/images/logo.png" class="logotype_button" width="38" />-->
     </div>
     <!--===-->
	...
	?>
    	<nav class="nav-secondary" role="navigation">
            <div class="wrapper">
                ...
                <div class="site-name"><img src="/wp-content/themes/catch-responsive/images/logo.png" class="logotype" width="38" /><div class="logotype-words"><a title="Музей історіі міста Києва" href="http://www.wp.loc/">УЗЕЙ ІСТОРІЇ МІСТА КИЄВА</a></div></div>
            <?php } else { ?>
            <div class="site-name"><img src="/wp-content/themes/catch-responsive/images/logo.png" class="logotype" width="38" /><div class="logotype-words"><a title="Музей історіі міста Києва" href="http://www.wp.loc/">USEUM OF HISTORY OF KYIV</a></div></div>
            <?php } ?>
